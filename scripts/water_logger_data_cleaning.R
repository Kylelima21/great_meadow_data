...
raw <- readxl::read_excel("data/GREAT MEADOW Full Data & New Graphs Nov-2022.xlsx", sheet = "Full Data to MAY 2022")
...
write.csv(clean, "outputs/great_meadow_well_data_20230121.csv", row.names = F)
